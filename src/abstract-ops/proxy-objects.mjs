...
function ProxyGetPrototypeOf() {
  ...
  const handlerProto = Q(unwind(Call(trap, handler, [target])));
...
function ProxySetPrototypeOf(V) {
  ...
  const booleanTrapResult = ToBoolean(Q(unwind((Call(trap, handler, [target, V])))));
...
function ProxyIsExtensible() {
  ...
  const booleanTrapResult = ToBoolean(Q(unwind((Call(trap, handler, [target])))));
...
function ProxyGetOwnProperty(P) {
  ...
  const trapResultObj = Q(unwind(Call(trap, handler, [target, P])));
...
function ProxyDefineOwnProperty(P, Desc) {
  ...
  const booleanTrapResult = ToBoolean(Q(unwind(Call(trap, handler, [target, P, descObj]))));
...
function ProxyHasProperty(P) {
  ...
  const booleanTrapResult = ToBoolean(Q(unwind(Call(trap, handler, [target, P]))));
  if (booleanTrapResult === Value.false) {
    const targetDesc = Q(target.GetOwnProperty(P));
    if (targetDesc !== Value.undefined) {
      if (targetDesc.Configurable === Value.false) {
...
function ProxyGet(P, Receiver) {
  ...
  if (trap === Value.undefined) {
    return Q(unwind(wrap(target.Get(P, Receiver))));
  }
  const trapResult = Q(unwind((Call(trap, handler, [target, P, Receiver]))));
  const targetDesc = Q(target.GetOwnProperty(P));
...
function ProxySet(P, V, Receiver) {
  ...
  const booleanTrapResult = ToBoolean(Q(unwind(Call(trap, handler, [target, P, V, Receiver]))));
  if (booleanTrapResult === Value.false) {
    return Value.false;
  }
  const targetDesc = Q(target.GetOwnProperty(P));
...
function ProxyOwnPropertyKeys() {
  ...
  const trapResultArray = Q(unwind(Call(trap, handler, [target])));
