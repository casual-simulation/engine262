...
export function* Evaluate(node) {
  ...
  switch (node.type) {
    ...
    case 'FunctionExpression':
      result = Evaluate_FunctionExpression(node);
      break;
    case 'ClassExpression':
      result = yield* Evaluate_ClassExpression(node);
      break;
    case 'GeneratorExpression':
      result = Evaluate_GeneratorExpression(node);
      break;
    case 'AsyncFunctionExpression':
      result = Evaluate_AsyncFunctionExpression(node);
      break;
    case 'AsyncGeneratorExpression':
      result = Evaluate_AsyncGeneratorExpression(node);
      break;
    ...
    case 'UnaryExpression':
      ...
      break;
    case 'ArrowFunction':
      result = Evaluate_ArrowFunction(node);
      break;
    case 'AsyncArrowFunction':
      result = Evaluate_AsyncArrowFunction(node);
      break;
